...
{% from "formula/utils/users.sls" import skeleton %}
...
{{ home }}/.bashrc:
  file.managed:
    - source: salt://formula/env/files/.bashrc
    - user: {{ user }}
    - group: {{ group }}

{{ home }}/.tmux.conf:
  file.managed:
    - source: salt://formula/env/files/.tmux.conf
    - user: {{ user }}
    - group: {{ group }}

{{ home }}/.vimrc:
  file.managed:
    - source: salt://formula/env/files/.vimrc
    - user: {{ user }}
    - group: {{ group }}
...
{{ home }}/.ssh/rc:
  file.managed:
    - source: salt://formula/env/files/.ssh/rc
    - user: {{ user }}
    - group: {{ group }}
...
{{ home }}/.vim/autoload/pathogen.vim:
  file.managed:
    - source: salt://formula/env/files/.vim/autoload/pathogen.vim
    - user: {{ user }}
    - group: {{ group }}
